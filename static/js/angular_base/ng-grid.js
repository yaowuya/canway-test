...
(function (window, $) {
    ...
    angular.module('ngGrid').run(['$templateCache', function ($templateCache) {
        ...
        $templateCache.put('checkboxHeaderTemplate.html',
            ...
            "<label>" +
            "<span class=\"checkbox-span\" ng-class=\"{'checkbox-checked': allSelected}\">" +
            "<span class=\"checkbox-inner\"></span>" +
            "<input type=\"checkbox\" tabindex='-1' ng-model=\"allSelected\" ng-change=\"toggleSelectAll(allSelected, true)\" class=\"ngSelectionCheckbox checkbox-input\">" +
            "</span>" +
            "</label>" +
            "</div>"
        );
